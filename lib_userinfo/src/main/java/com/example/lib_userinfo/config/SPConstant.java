...
public class SPConstant {
    ...
    public static final String USER_LOGIN_FILE = "user_login_file"; //存储用户账户文件名
    ...
    public static final String USER_SESSION_ID = "user_session_id";//用户sessionId
    public static final String USER_IDENTITY = "user_identity";//用户身份
